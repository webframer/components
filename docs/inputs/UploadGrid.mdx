...
UploadGrid is a set of file [Upload](/docs/ui/inputs/Upload) inputs with multiple dropzones in a grid-like layout. Each dropzone can show image preview of selected files, with extra info, such as image resolution and file size.
